...
<html>
	...
	<body>	
		...
		var animator = new Animator("Тук-тук...признайся, тебя все время терзали мысли, что что-то идет не так, ты учишь все эти предметы, но по настоящему не чувствуешь себя студентом? Давай, я расскажу тебе, что нужно сделать, чтобы стать настоящим студентом. Ну так что, готов узнать, насколько глубока кроличья нора?<br>Кто ты?", 75, "text", "form");
